...
export const PLAN_OPTIONS = [
  { serial: 1, label: "ESTIM - To control pain and swelling" },
  { serial: 2, label: "Moist Heat Pack (MHP) - Reduce pain & increase flexibility" },
  { serial: 3, label: "Cold Pack (CP) - Reduce pain and inflammation" },
  { serial: 4, label: "MFR - To reduce muscle spasm & increase flexibility & To restore mobility to restricted soft tissue" },
  { serial: 5, label: "Joint Mobs - Reduce pain and increase flexibility" },
  { serial: 6, label: "Therapeutic Massage - For pain reduction & improving flexibility & to increase blood, lymph circulation & reduce swelling" },
  { serial: 7, label: "Trigger point release - To reduce pain & increase flexibility" },
  { serial: 8, label: "Manual Stretching - To restore flexibility" },
  { serial: 9, label: "PROM/AROM Exerc - To restore ROM to restricted areas" },
  { serial: 10, label: "Resistance exercises - To improve strength and coordination" },
  { serial: 11, label: "Postural reeducation - To correct posture" },
  { serial: 12, label: "NMR - To improve posture and proprioception" },
  { serial: 13, label: "NMR - To improve kinesthetic sense & motor efficiency" },
  { serial: 14, label: "NMR - To improve balance & coordination" },
  { serial: 15, label: "PNF - To improve flexibility, reduce muscle spasm & muscle elasticity" },
  { serial: 16, label: "Dynamic exerc. - To restore functional performance" },
  { serial: 17, label: "Taping - Posture correction & To correct movement mechanics" },
  { serial: 18, label: "Taping - To reduce pain, swelling & to restrict joint movement" },
  { serial: 19, label: "HEP - To maintain the acquired functional ability" },
  { serial: 20, label: "Patient education - To prevent worsening of the condition" },
  { serial: 21, label: "ADLs/IADLS training - To perform ADLs and IADLS w/o restriction" },
  { serial: 22, label: "Stationary Bike - To increase ROM, reduce swelling, increase flexibility" },
  { serial: 23, label: "US - To reduce deep tissue inflammation" },
  { serial: 24, label: "Balance Training - To improve & normalize balance & coordination" },
  { serial: 25, label: "Stairs training - To help with stair negotiation" },
  { serial: 29, label: "McKenzie Exercise Program - To restore ROM & functional mobility" },
  { serial: null, label: "Gait training - To improve and normalize gait." },
  { serial: null, label: "HEP - To prevent worsening of the condition" },
  { serial: null, label: "McKenzie Exercise Program - To restore ROM" },
  { serial: null, label: "Paraffin - To improve flexibility & reduce pain" },
  { serial: null, label: "PNF - To increase ROM" }
];
